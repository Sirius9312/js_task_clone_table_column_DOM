...
header.children[header.children.length - 1].parentNode.removeChild(header.children[header.children.length - 1]);
...
for(let i = 0; i < main.length; i++){
    ...
    main[i].children[main[i].children.length - 1].parentNode.removeChild(main[i].children[main[i].children.length - 1]);
}
addNewList(main, positionsList);
addNewList(main, salariesList);
// Add new column fields in footer
footer.children[footer.children.length - 1].parentNode.removeChild(footer.children[footer.children.length - 1]);
